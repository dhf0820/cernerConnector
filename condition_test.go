...
func TestFindConditions(t *testing.T) {
	Convey("TestFindConditions", t, func() {
		...
		// So(err, ShouldBeNil)
		// So(conf, ShouldNotBeNil)
		req, err := http.NewRequest("GET", "/system/640ba5e3bd4105586a6dda74/Condition?patient=12724068", nil)
		...
		So(resResp.Resource.Condition, ShouldNotBeNil)
