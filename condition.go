...
func findCondition(w http.ResponseWriter, r *http.Request) {
...
func GetCondition(cp *common.ConnectorPayload, resourceName, resourceId string, token string) (json.RawMessage, error) {
