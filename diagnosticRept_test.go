...
func TestSimpleFindDiagnosticRepts(t *testing.T) {
	Convey("TestSimpleFindDiagnosticRept", t, func() {
		...
		//os.Setenv mongodb+srv://dhfadmin:Sacj0nhati@cluster1.24b12.mongodb.net/test?retryWrites=true&w=majority
		...
		// So(err, ShouldBeNil)
		// So(conf, ShouldNotBeNil)
		req, err := http.NewRequest("GET", "system/640ba5e3bd4105586a6dda74/DiagnosticReport?patient=12724067", nil)
